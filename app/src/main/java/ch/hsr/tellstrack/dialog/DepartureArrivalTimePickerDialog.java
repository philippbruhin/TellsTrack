package ch.hsr.tellstrack.dialog;
...
import ch.hsr.tellstrack.TimetableFragment;
...
public class DepartureArrivalTimePickerDialog
            ...
            builder.setView(view)
                    .setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int id) {
                            ...
                            {
                                _departureArrivalTime.calendar.set(datepicker.getYear(), datepicker.getMonth(), datepicker.getDayOfMonth(), timepicker.getCurrentHour(), timepicker.getCurrentMinute(), 0);
                            }

                            ((TimetableFragment)getTargetFragment()).updateDepartureArrivalTime(_departureArrivalTime);
                        }
                    })
    ...
    private void SetupDialog(DepartureArrivalTime departureArrivalTime,  View view) {
        ...
        {
            timepicker.setCurrentHour(departureArrivalTime.calendar.get(Calendar.HOUR_OF_DAY));
            timepicker.setCurrentMinute(departureArrivalTime.calendar.get(Calendar.MINUTE));
        }
